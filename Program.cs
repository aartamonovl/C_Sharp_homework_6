...
// Console.WriteLine("Input as many numbers as you want. To stay input nothing.");
// var sNumber = Console.ReadLine();
// int countAll = 0;
// while(sNumber != string.Empty)
// {
//         countAll = CountGreaterZero(Convert.ToInt32(sNumber), countAll);
